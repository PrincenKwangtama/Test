...
namespace Tes
{
    internal class Asset3D
    {
        ...
        public Asset3D(List<Vector3> vertices, List<uint> indices, float[] color)
        {
            _vertices = vertices;
            _indices = indices;
            _color = color;
        ...
        public Asset3D(float r,float g,float b,float alpha)
        {
            _color[0] = r;
            _color[1] = g;
            _color[2] = b;
        ...
        public void render(int pilihan, Matrix4 temp,double time,Matrix4 camera_view,Matrix4 camera_projection)
        {
            ...
            {                
                ...
                {
                    GL.DrawArrays(PrimitiveType.LineStrip, 0, indexGaris);
                }
                else if (pilihan == 5)
                {
        ...
        public void rotate(Vector3 pivot, Vector3 vector, float angle)
        {
            ...
            foreach (var item in Child)
            {
                item.rotate(pivot, vector, angle);
            }
        }
        ...
        {
            Asset3D newChild = new Asset3D(_color[0],_color[1],_color[2],_color[3]);
