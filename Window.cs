    ...
    internal class Window : GameWindow
    {
        ...
        */
        ...
        protected override void OnLoad()
        {
            ...
            _object3d[8].createPararelogram(0,-0.15f,2.38f,0.68f,2.5f,1.4f,0.3f);

            //logo ukp 
            _object3d.Add(new Asset3D(1f, 1f, 1f, 1f));
            _object3d[9].createTube(-0.8f, 0.08f, 0.4f, 0.09f, 0.05f,1,true);
            _object3d[9].createTubeChild(-0.8f, 0.08f, 0.46f, 0.07f, 0.01f, 0.4, true, 0.8f, 0.8f, 0.8f, 1f);
            _object3d[9].createTubeChild(-0.8f, 0.08f, 0.45f, 0.07f, 0.01f, 1, false, 0.2f, 0.2f, 0.8f, 1f);
            _object3d[9].createBoxChild(-0.78f, 0.037f, 0.465f, 0.02f, 0.045f, 0.01f,0,0,0,1f);
            _object3d[9].createBoxChild(-0.82f, 0.037f, 0.465f, 0.02f, 0.045f, 0.01f, 0, 0, 0, 1f);
            _object3d[9].createBoxChild(-0.78f, 0.037f, 0.472f, 0.001f, 0.045f, 0.01f);
            _object3d[9].createBoxChild(-0.82f, 0.037f, 0.472f, 0.001f, 0.045f, 0.01f);
            _object3d[9].createBoxChild(-0.8f, 0.11f, 0.46f, 0.07f, 0.01f, 0.01f);
            _object3d[9].createBoxChild(-0.8f, 0.095f, 0.46f, 0.01f, 0.09f, 0.01f);
            _object3d[9].createCrescentChild(-0.842f,0.094f,0.46f, 0.038f,0.025f, 0.0075f, true,1f,1f,0,1f);
            _object3d[9].createCrescentChild(-0.758f, 0.094f, 0.46f, 0.038f, 0.025f, 0.0075f, true, 1f, 1f, 0, 1f);

            //tulisan ukp
            //_object3d.Add(new Asset3D(1f, 1f, 1f, 1f));
            //u
            //_object3d[10].createBoxVertices(-0.6f,0.08f,0.4f,0.05f,0.1f,0.05f);
            //_object3d[10].createRingChild(-0.55f,0.05f,0.4f,0.075f,0.025f,0.05f,-180,0);
            //_object3d[10].createBoxChild(-0.5f,0.08f,0.4f, 0.05f, 0.1f, 0.05f);

            //k
            //_object3d[10].createBoxChild(-0.4f, 0.06f, 0.4f, 0.05f, 0.15f, 0.05f);

            //p
            //_object3d[10].createBoxChild(-0.2f, 0.06f, 0.4f, 0.05f, 0.15f, 0.05f);

            /*
            //orang 1
            _object3d.Add(new Asset3D(0.87f, 0.68f, 0.45f, 1f));
            _object3d[11].createBoxVertices(-1.6f, -0.17f, 0, 0.15f,0.15f,0.15f);
            _object3d[11].addChild(-1.6f, -0.17f, 0, 0.15f, 0, 0.87f, 0.68f, 0.45f, 1f);
            _object3d[11].addChild(-1.65f, -0.15f, 0.07f, 0.02f, 0, 0.90f, 0.90f, 0.90f, 1f);
            _object3d[11].addChild(-1.63f, -0.15f, 0.07f, 0.02f, 0, 0.13f, 0.13f, 0.13f, 1f);
            _object3d[11].addChild(-1.55f, -0.15f, 0.07f, 0.02f, 0, 0.99f, 0.99f, 0.99f, 1f);
            _object3d[11].addChild(-1.57f, -0.15f, 0.07f, 0.02f, 0, 0.13f, 0.13f, 0.13f, 1f);
            _object3d[11].addChild(-1.61f, -0.20f, 0.07f, 0.02f, 0, 0.13f, 0.13f, 0.13f, 1f);
            _object3d[11].addChild(-1.59f, -0.20f, 0.07f, 0.02f, 0, 0.13f, 0.13f, 0.13f, 1f);

            //topi
            
            _object3d[11].addChild(-1.67f, -0.08f, 0.05f, 0.05f, 0, 0.13f, 0.13f, 0.13f, 1f);
            _object3d[11].addChild(-1.67f, -0.08f, 0.08f, 0.05f, 0, 0.13f, 0.13f, 0.13f, 1f);
            _object3d[11].addChild(-1.67f, -0.08f, 0.13f, 0.05f, 0, 0.13f, 0.13f, 0.13f, 1f);
            _object3d[11].addChild(-1.62f, -0.08f, 0.05f, 0.05f, 0, 0.13f, 0.13f, 0.13f, 1f);
            _object3d[11].addChild(-1.62f, -0.08f, 0.08f, 0.05f, 0, 0.13f, 0.13f, 0.13f, 1f);
            _object3d[11].addChild(-1.62f, -0.08f, 0.13f, 0.05f, 0, 0.13f, 0.13f, 0.13f, 1f);

            _object3d[11].addChild(-1.57f, -0.08f, 0.05f, 0.05f, 0, 0.13f, 0.13f, 0.13f, 1f);
            _object3d[11].addChild(-1.57f, -0.08f, 0.08f, 0.05f, 0, 0.13f, 0.13f, 0.13f, 1f);
            _object3d[11].addChild(-1.57f, -0.08f, 0.13f, 0.05f, 0, 0.13f, 0.13f, 0.13f, 1f);

            _object3d[11].addChild(-1.53f, -0.08f, 0.05f, 0.05f, 0, 0.13f, 0.13f, 0.13f, 1f);
            _object3d[11].addChild(-1.53f, -0.08f, 0.08f, 0.05f, 0, 0.13f, 0.13f, 0.13f, 1f);
            _object3d[11].addChild(-1.53f, -0.08f, 0.13f, 0.05f, 0, 0.13f, 0.13f, 0.13f, 1f);
            

            //badan
            _object3d[11].addChild(-1.6f, -0.26f, 0, 0.07f, 0, 0.87f, 0.68f, 0.45f, 1f);
            _object3d[11].addChildBalok(-1.6f, -0.44f, 0f, 0.12f, 0.33f, 0.12f, 1, 0.54f, 0.64f, 0.48f, 1f);

            //tangan
            _object3d[11].addChild(-1.70f, -0.315f, 0, 0.08f, 0, 0.05f, 0.31f, 0.55f, 1f);
            _object3d[11].addChild(-1.72f, -0.33f, 0, 0.08f, 0, 0.05f, 0.31f, 0.55f, 1f);
            _object3d[11].addChild(-1.74f, -0.38f, 0, 0.08f, 0, 0.87f, 0.68f, 0.45f, 1f);
            _object3d[11].addChild(-1.72f, -0.45f, 0, 0.08f, 0, 0.87f, 0.68f, 0.45f, 1f);

            _object3d[11].addChild(-1.50f, -0.315f, 0, 0.08f, 0, 0.05f, 0.31f, 0.55f, 1f);
            _object3d[11].addChild(-1.48f, -0.33f, 0, 0.08f, 0, 0.05f, 0.31f, 0.55f, 1f);
            _object3d[11].addChild(-1.46f, -0.38f, 0f, 0.08f, 0, 0.87f, 0.68f, 0.45f, 1f);
            _object3d[11].addChild(-1.48f, -0.45f, 0f, 0.08f, 0, 0.87f, 0.68f, 0.45f, 1);
            _object3d[11].addChild(-1.49f, -0.50f, 0f, 0.08f, 0, 0.87f, 0.68f, 0.45f, 1f);

            //kaki
            _object3d[11].addChildBalok(-1.55f, -0.73f, -0.02f, 0.08f, 0.25f, 0.08f, 1, 0.14f, 0.38f, 0.35f, 1f);
            _object3d[11].addChild(-1.55f, -0.90f, -0.02f, 0.08f, 0, 0.87f, 0.68f, 0.45f, 1f);
            _object3d[11].addChild(-1.55f, -0.86f, -0.02f, 0.08f, 0, 0.14f, 0.38f, 0.35f, 1f);

            _object3d[11].addChildBalok(-1.65f, -0.73f, -0.02f, 0.08f, 0.25f, 0.08f, 1, 0.14f, 0.38f, 0.35f, 1f);
            _object3d[11].addChild(-1.65f, -0.90f, -0.02f, 0.08f, 0, 0.87f, 0.68f, 0.45f, 1f);
            _object3d[11].addChild(-1.65f, -0.86f, -0.02f, 0.08f, 0, 0.14f, 0.38f, 0.35f, 1f);
            */
            ...
            //_object3d.Add(new Asset3D());
            //_object3d.Add(new Asset3D());

            //transformasi  mulai disini                       
            _object3d[9].RotateOnCore(2,18,0);
            _object3d[9].RotateOnCore(2, 25, 2);
            _object3d[9].RotateOnCore(2, 25, 4);
            _object3d[9].RotateOnCore(2,-25,3);
            _object3d[9].RotateOnCore(2, -25, 5);
            _object3d[9].RotateOnCore(2,30 , 8);
            _object3d[9].RotateOnCore(2, -30, 9);
        }
