    ...
    internal class window : GameWindow
    {
        ...
        */
        ...
        protected override void OnLoad()
        {
            ...
            Console.WriteLine(_object3d[12]._centerPosition);
            Console.WriteLine(_object3d[13]._centerPosition);
            Console.WriteLine(_object3d[14]._centerPosition);
        }
        ...
        {
            if (_object3d[index1]._centerPosition.Y >= 0.8 || _object3d[index1]._centerPosition.Y <= -0.8)
            {
                time_kanan = -1;
            }

            if (_object3d[index2]._centerPosition.Y <= -0.8 || _object3d[index2]._centerPosition.Y >= 0.8)
            {
                time_kiri = -1;
            }

            _object3d[index1].Translate(0f, 0.1f * time_kanan, 0f);
            _object3d[index1].spin(_object3d[center].ChangeVector(0f,0f,0f), Vector3.UnitZ, time_kanan);
            _object3d[index2].Translate(0f, 0.1f * time_kiri, 0f);
            _object3d[index2].spin(_object3d[center].ChangeVector(0f, 0f, 0f), Vector3.UnitZ, time_kiri);
        }
        ...
        public void animation_tangan_biasa(int index1, int index2, int center)
        {
            ...
            _object3d[index1].spin(_object3d[center]._centerPosition, Vector3.UnitZ, time_tangan_kanan);
            _object3d[index2].Translate(0f, 0.1f * time_tangan_kiri, 0f);
            _object3d[index2].spin(_object3d[center]._centerPosition, Vector3.UnitZ, time_tangan_kiri);
        }
        ...
        public void animation_tangan_gaya(int index1, int index2, int center)
        {
            ...
            _object3d[index1].spin(_object3d[center]._centerPosition, Vector3.UnitZ, time_tangan_gaya_kanan);
            _object3d[index2].Translate(0f, 0.1f * time_tangan_gaya_kiri, 0f);
            _object3d[index2].spin(_object3d[center]._centerPosition, Vector3.UnitZ, time_tangan_gaya_kiri);
        }
